        ...
        <div id="AndrezzzVPS" style="display: none;">
            ...
            <div class="dashboard-tab" id="dashboard">
                <ul class="nav nav-tabs mb-4 dash-tabs" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="rdns-tab" data-bs-toggle="tab" data-bs-target="#rdns" role="tab" aria-controls="rdns" aria-selected="false"><i class="fa-solid fa-ethernet"></i> Reverse DNS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="settings-tab" data-bs-toggle="tab" data-bs-target="#settings" onclick="AndrezzzVPS_API('ISO Images', false, { currentISO: '{$serverInfo['iso']}' });" role="tab" aria-controls="settings" aria-selected="false"><i class="fa-solid fa-gear"></i> Settings</a>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="rdns" role="tabpanel" aria-labelledby="rdns-tab">
                        ...
                        <div id="vpsrdns_div">
                            ...
                            <button onclick="AndrezzzVPS_API('Reverse DNS', true, { ip: $_('rdnsIP').value, val: $_('rdnsDomain').value });;return false;" class="submit-btn">Add Reverse DNS</button>
                        </div>
                    </div>
                        ...
                        <div class="row vertical-tabs">
                            <div class="col-12 col-sm-2 col-md-3 col-lg-2 v-tabs-container">
                                <div class="nav flex-md-column mx-auto left-side-tabs mb-4 mb-md-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link mr-2 mr-md-0 active" id="iso-tab" data-bs-toggle="tab" data-bs-target="#iso" role="tab" aria-controls="iso" aria-selected="true" style="display: block">ISO</a>
                            ...
                            <div class="col-12 col-sm-10 col-md-9 col-lg-10">
                                <div class="tab-content vertical-tab-content">
                                    <div class="tab-pane fade active show" id="iso" role="tabpanel" aria-labelledby="iso-tab">
                                        <div class="head">
                                            <img src="{$images['edit']}">
                                    ...
                                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                                        ...
                                        <div class="mb-3" style="width: 50%;">
                                            ...
                                            <span class="input-group mb-3">
                                                <input class="form-control" id="vpsPassword" type="password" size="30" maxlength="128" disabled value="{if $serverInfo['root'] != ''}{$serverInfo['root']}{else}Expired{/if}">
